...
func (sc *Smartcard) makeTau0() (*math.Zr, *math.G1) {
...
func (sc *Smartcard) Receive() (*math.Zr, *math.G1) {
	// increment counter
	sc.ctr++
...
func (sc *Smartcard) Spend(nonce, tau []byte) ([]byte, error) {
...
func (sc *Smartcard) Verify(proofBytes, tau0, tau, nonce []byte) error {
