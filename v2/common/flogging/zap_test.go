...
import (
	...
	"github.com/IBM/idemix/v2/common/flogging"
	"github.com/IBM/idemix/v2/common/flogging/fabenc"
	"github.com/IBM/idemix/v2/common/flogging/mock"
...
func TestGRPCLogger(t *testing.T) {
	...
	require.Equal(t, "grpc DEBUG callWrapper message\n", buf.String())
}
