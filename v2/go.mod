module github.com/IBM/idemix/v2

go 1.22.6

require (
	github.com/IBM/idemix/bccsp/schemes/aries v0.0.0-20240612072411-114d281b442d
...
replace (
	github.com/IBM/idemix/bccsp/schemes/aries => ../bccsp/schemes/aries/
	github.com/IBM/idemix/bccsp/types => ../bccsp/types/
)
